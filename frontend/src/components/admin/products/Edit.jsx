...
const Edit = ({ placeholder }) => {
  ...
  const {
    ...
    defaultValues: async () => {
      const res = await axios(`${apiUrl}products/${params.id}`, {
        method: "Get",
        headers: {
          Authorization: `Bearer ${token()}`,
      ...
      return {
        ...
        compare_price: res.data.product.compare_price,
        content: res.data.product.description,
        ...
        is_featured: res.data.product.is_featured,
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const res = await axios.put(`${apiUrl}products/${params.id}`, data, {
        headers: {
          Accept: "application/json",
          Authorization: `Bearer ${token()}`,
        },
      ...
      <div className="card shadow border-0">
        <div className="card-body p-4">
          <div className="d-flex justify-content-between">
            <h4 className="h5">Product / Edit</h4>
